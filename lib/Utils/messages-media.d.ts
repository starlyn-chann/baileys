...
export declare function transcodeAudioToOpus(input: string | Buffer): Promise<string>;
...
export declare const resizeImage: (buf: Buffer, width: number, height: number, opts?: {
    quality?: number;
}) => Promise<Buffer>;
export declare const convertMedia: (buf: Buffer, opts: {
    to: string;
}) => Promise<Buffer>;
export declare const imageToWebpSticker: (buf: Buffer, opts?: {
    quality?: number;
}) => Promise<Buffer>;
export declare const compressMedia: (buf: Buffer, opts?: {
    quality?: number;
}) => Promise<Buffer>;
...
export declare const getMediaMetadata: (buf: Buffer) => Promise<MediaMetadataResult>;
export {};
