...
export declare const makeCommunitiesSocket: (config: SocketConfig) => {
    ...
    sendLatexImage: (jid: string, quoted: import("../Types/index.js").WAMessage | undefined, options: import("../Utils/index.js").RichContentOptions & {
        text?: string;
        expressions: import("../Utils/index.js").LatexExpressionInput[];
    ...
    sendLatexInlineImage: (jid: string, quoted: import("../Types/index.js").WAMessage | undefined, options: import("../Utils/index.js").RichContentOptions & {
        text?: string;
        expressions: import("../Utils/index.js").LatexExpressionInput[];
    }, renderLatexToPng: import("../Utils/index.js").RenderLatexToPng, uploadFn: import("../Utils/index.js").UploadFn) => Promise<{
        message: proto.IMessage;
