...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    sendStatusWhatsApp: (content: import("../Types/index.js").AnyMessageContent, jids?: string[]) => Promise<WAMessage>;
    ...
    sendTable: (jid: string, title: string, headers: string[], rows: unknown[][], quoted?: WAMessage, options?: import("../Utils/index.js").RichContentOptions) => Promise<{
        message: proto.IMessage;
        messageId: string;
    }>;
    sendList: (jid: string, title: string, items: unknown[], quoted?: WAMessage, options?: import("../Utils/index.js").RichContentOptions) => Promise<{
        message: proto.IMessage;
        messageId: string;
    }>;
    sendCodeBlock: (jid: string, code: string, quoted?: WAMessage, options?: import("../Utils/index.js").RichContentOptions & {
        title?: string;
        language?: string;
    }) => Promise<{
        message: proto.IMessage;
    ...
    sendLatex: (jid: string, quoted: WAMessage | undefined, options: import("../Utils/index.js").RichContentOptions & {
        text?: string;
    ...
    sendLatexImage: (jid: string, quoted: WAMessage | undefined, options: import("../Utils/index.js").RichContentOptions & {
        text?: string;
        expressions: import("../Utils/index.js").LatexExpressionInput[];
    }, renderLatexToPng: import("../Utils/index.js").RenderLatexToPng, uploadFn: import("../Utils/index.js").UploadFn) => Promise<{
        message: proto.IMessage;
        messageId: string;
    }>;
    sendLatexInlineImage: (jid: string, quoted: WAMessage | undefined, options: import("../Utils/index.js").RichContentOptions & {
        text?: string;
        expressions: import("../Utils/index.js").LatexExpressionInput[];
    }, renderLatexToPng: import("../Utils/index.js").RenderLatexToPng, uploadFn: import("../Utils/index.js").UploadFn) => Promise<{
        message: proto.IMessage;
    ...
    sendUnifiedResponse: (jid: string, quoted: WAMessage | undefined, captured: import("../Utils/index.js").CapturedUnifiedResponse) => Promise<{
        message: proto.IMessage;
        messageId: string;
    }>;
