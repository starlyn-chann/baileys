...
import { type BinaryNode, type LidPhoneCache } from '../WABinary/index.js';
...
export declare const extractGroupMetadata: (result: BinaryNode, phoneCache?: LidPhoneCache) => GroupMetadata;
